...
if (length(args_raw) != 3) {
  cat(WHITE, 'Usage: Rscript index_align_bulk.R ', usage_str, RESET, '\n\n', sep = '')
  cat_col("Performs the alignment of RNA-Seq reads to the reference genome using STAR", color = YELLOW)
  cat('\n')
